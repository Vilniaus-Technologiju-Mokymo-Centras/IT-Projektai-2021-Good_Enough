...
export default class TaskEdit extends Component {
    ...
    constructor(props) {
        ...
        this.api = `http://localhost:8080/api/projects/${params.projectId}/tasks/${params.taskId}`;
    }
        ...
        return (
            <Card>
                ...
                <Form onReset={this.resetTask} onSubmit={this.submitTask} id="taskFormId">
                    ...
                    <Card.Footer>
                        <Button size="sm" variant="success" type="submit" onClick={this.successToast} >Save</Button>{' '}

                        <Button size="sm" variant="info" type="reset" onClick={this.resetToast}>Reset</Button>{' '}
