...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2021 at 10:25 PM
...
CREATE TABLE `projects` (
  ...
  `project_status` enum('in progress','done') NOT NULL,
...
CREATE TABLE `roles` (
  `id` int(11) NOT NULL,
  `role_name` enum('manager','admin') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tasks` (
  ...
  `description` text NOT NULL,
  `priority` enum('žemas','vidutinis','aukštas') NOT NULL,
